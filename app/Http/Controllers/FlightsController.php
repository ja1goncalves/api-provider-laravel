...
class FlightsController extends Controller
{
    ...
    public function store(FlightCreateRequest $request)
    {
        try {
            ...
            $flight = $this->repository->create($request->all());
    ...
    public function update(FlightUpdateRequest $request, $id)
    {
        try {
            ...
            $flight = $this->repository->update($request->all(), $id);
    ...
    public function destroy($id)
    {
        ...
        return redirect()->back()->with('message', 'Flight deleted.');
    }
}
